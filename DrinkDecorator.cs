...
namespace Design_Pattern_Project
{
    ...
    public class BobaDecorator : DrinkDecorator
    {
        ...
        public override string Description => $"{_drink.Description}, Boba";
    ...
    public class JellyDecorator : DrinkDecorator
    {
        ...
        public override string Description => $"{_drink.Description}, Jelly";
        public override double Cost => _drink.Cost + 0.25;
    }
}
